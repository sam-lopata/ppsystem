...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'FrameworkBundle', '/var/www/sam/data/www/ppsystem.dev/vendor/symfony/src/Symfony/Bundle/FrameworkBundle/Resources/views', '/^[^.]+\\.[^.]+\\.twig$/'), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'TwigBundle', '/var/www/sam/data/www/ppsystem.dev/vendor/symfony/src/Symfony/Bundle/TwigBundle/Resources/views', '/^[^.]+\\.[^.]+\\.twig$/'), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'DoctrineBundle', '/var/www/sam/data/www/ppsystem.dev/vendor/symfony/src/Symfony/Bundle/DoctrineBundle/Resources/views', '/^[^.]+\\.[^.]+\\.twig$/'), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'WebProfilerBundle', '/var/www/sam/data/www/ppsystem.dev/vendor/symfony/src/Symfony/Bundle/WebProfilerBundle/Resources/views', '/^[^.]+\\.[^.]+\\.twig$/'), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'SymfonyWebConfiguratorBundle', '/var/www/sam/data/www/ppsystem.dev/vendor/bundles/Symfony/Bundle/WebConfiguratorBundle/Resources/views', '/^[^.]+\\.[^.]+\\.twig$/'), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'AcmeDemoBundle', '/var/www/sam/data/www/ppsystem.dev/src/Acme/DemoBundle/Resources/views', '/^[^.]+\\.[^.]+\\.twig$/'), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, '', '/var/www/sam/data/www/ppsystem.dev/app/views', '/^[^.]+\\.[^.]+\\.twig$/'), 'twig');
    ...
    {
        return $this->services['assetic.filter.less'] = new \Assetic\Filter\LessFilter('/var/www/sam/data/www/ppsystem.dev/app/../web', '/usr/bin/node', array());
    }
    ...
    {
        return $this->services['assetic.filter.sprockets'] = new \Assetic\Filter\SprocketsFilter('/var/www/sam/data/www/ppsystem.dev/app/../web', '/usr/bin/sprocketize');
    }
    ...
    {
        return $this->services['assetic.filter.stylus'] = new \Assetic\Filter\StylusFilter('/var/www/sam/data/www/ppsystem.dev/app/../web', '/usr/bin/node', array());
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('host' => 'localhost', 'driver' => 'pdo_mysql', 'driverOptions' => array(), 'user' => 'ppsystem', 'password' => 'c13cad2063', 'port' => NULL, 'dbname' => 'ppsystem'), $a, new \Doctrine\Common\EventManager());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $d->setProxyDir('/var/www/sam/data/www/ppsystem.dev/app/cache/dev/doctrine/orm/Proxies');
    ...
    {
        return $this->services['form.csrf_provider'] = new \Symfony\Component\Form\CsrfProvider\SessionCsrfProvider($this->get('session'), '7ca6af2710aefadc6610621767c1021a067');
    }
    ...
    protected function getLoggerService()
    {
        ...
        $b = new \Zend\Log\Writer\Stream('/var/www/sam/data/www/ppsystem.dev/app/logs/dev.log');
        $b->addFilter($a);
...
'));
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, '/var/www/sam/data/www/ppsystem.dev/app');
    }
    ...
    {
        $this->services['translator.real'] = $instance = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('cache_dir' => '/var/www/sam/data/www/ppsystem.dev/app/cache/dev/translations', 'debug' => true), $this->get('session'));
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), '/var/www/sam/data/www/ppsystem.dev/app/../web', true);
    ...
    {
        return $this->services['profiler.storage'] = new \Symfony\Component\HttpKernel\Profiler\SqliteProfilerStorage('/var/www/sam/data/www/ppsystem.dev/app/cache/dev/profiler.db', 86400);
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), '/var/www/sam/data/www/ppsystem.dev/app');
    }
    ...
    {
        return $this->services['validator.mapping.class_metadata_factory'] = new \Symfony\Component\Validator\Mapping\ClassMetadataFactory(new \Symfony\Component\Validator\Mapping\Loader\LoaderChain(array(0 => new \Symfony\Component\Validator\Mapping\Loader\AnnotationLoader(array('validation' => 'Symfony\\Component\\Validator\\Constraints\\')), 1 => new \Symfony\Component\Validator\Mapping\Loader\StaticMethodLoader('loadValidatorMetadata'), 2 => new \Symfony\Component\Validator\Mapping\Loader\XmlFilesLoader(array(0 => '/var/www/sam/data/www/ppsystem.dev/vendor/symfony/src/Symfony/Bundle/FrameworkBundle/DependencyInjection/../../../Component/Form/Resources/config/validation.xml')), 3 => new \Symfony\Component\Validator\Mapping\Loader\YamlFilesLoader(array()))));
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'mailer_password' => '',
            'locale' => 'en',
            'csrf_secret' => '7ca6af2710aefadc6610621767c1021a067',
            ...
            'form.csrf_protection.secret' => '7ca6af2710aefadc6610621767c1021a067',
            ...
            'profiler.storage.file' => '/var/www/sam/data/www/ppsystem.dev/app/cache/dev/profiler.db',
            ...
            'routing.resource' => '/var/www/sam/data/www/ppsystem.dev/app/config/routing_dev.yml',
...
',
            ...
            'zend.logger.path' => '/var/www/sam/data/www/ppsystem.dev/app/logs/dev.log',
            'swiftmailer.class' => 'Swift_Mailer',
            'swiftmailer.transport.sendmail.class' => 'Swift_Transport_SendmailTransport',
            'swiftmailer.transport.mail.class' => 'Swift_Transport_MailTransport',
            'swiftmailer.transport.failover.class' => 'Swift_Transport_FailoverTransport',
            'swiftmailer.init_file' => '/var/www/sam/data/www/ppsystem.dev/vendor/swiftmailer/lib/swift_init.php',
            'swiftmailer.plugin.redirecting.class' => 'Swift_Plugins_RedirectingPlugin',
            'swiftmailer.plugin.blackhole.class' => 'Swift_Plugins_BlackholePlugin',
            'swiftmailer.base_dir' => '/var/www/sam/data/www/ppsystem.dev/vendor/swiftmailer/lib',
